...
use Annonces\SiteBundle\Entity\Categorie;
use Annonces\SiteBundle\Form\CategorieType;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AnnoncesSiteBundle:Categorie')->findAll();
     ...
     * @Method("POST")
     * @Template("AnnoncesSiteBundle:Categorie:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AnnoncesSiteBundle:Categorie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AnnoncesSiteBundle:Categorie:edit.html.twig")
     */
