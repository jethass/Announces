...
use Annonces\SiteBundle\Entity\Categories;
use Annonces\SiteBundle\Form\CategoriesType;
...
class CategoriesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AnnoncesSiteBundle:Categories')->findAll();
     ...
     * @Method("POST")
     * @Template("AnnoncesSiteBundle:Categories:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AnnoncesSiteBundle:Categories')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AnnoncesSiteBundle:Categories:edit.html.twig")
     */
